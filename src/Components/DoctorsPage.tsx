...
const doctorsArray = [
    {
        ...
        description: 'Массаж представляет собой механическое воздействие на мягкие ткани тела, включая мышцы, связки и суставы.' +
            ' Эта процедура способствует улучшению кровообращения, снятию мышечного напряжения и уменьшению болевых ощущений. '
    },
    {
        name: 'Имя Фамилия 2',
